...
class Mob(Entity):
    """Ennemi simple qui se déplace en patrouille."""
    def __init__(self, maze, start_x, start_y, speed=0.05, pattern="horizontal", distance=3):
        super().__init__(maze, start_x, start_y, speed)
    ...
    def update(self):
        """Met a jour la position selon le pattern."""
    ...
    def collides_with(self, player):
        """Verifie la collision avec le joueur."""
